...
{
	g_CvarWardenColor = CreateConVar("jwp_warden_rgba", "255 255 0 255", "÷вет скина который получит командир (rgba)", FCVAR_PLUGIN);
	g_CvarWardenZamColor = CreateConVar("jwp_warden_zam_rgba", "0 255 255 255", "÷вет скина который получит зам командира (rgba)", FCVAR_PLUGIN);
